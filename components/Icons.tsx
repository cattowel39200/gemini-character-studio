...
export const MagicWandIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-3.483 0l-1.245 1.245a3 3 0 000 4.242L6.24 23.055a3 3 0 004.242 0l1.245-1.245a3 3 0 000-4.242l-1.43-1.43a3 3 0 00-3.483 0zm0 0L6.06 19.64m3.47-3.518l-3.518 3.47m3.518-3.47a5.25 5.25 0 00-7.424-7.424 5.25 5.25 0 007.424 7.424m-7.424-7.424L12 12" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 7.5l2.25 2.25m0 0l2.25 2.25M18.75 9.75l2.25-2.25m-2.25 2.25l-2.25 2.25" />
    </svg>
);
...
export const MagnifyingGlassPlusIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const BeakerIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19 14.5M14.25 3.104c.251.023.501.05.75.082M19 14.5v.75a3.75 3.75 0 01-7.5 0v-.75M4.5 19.5a3 3 0 013-3h9a3 3 0 013 3h-15z" />
    </svg>
);
...
export const AspectRatioHorizontalIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
      <rect x="3" y="8" width="18" height="8" rx="1" />
    </svg>
);

export const AspectRatioVerticalIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
